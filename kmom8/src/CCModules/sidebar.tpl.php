...
<div class='box'>
<h4>Lycka core</h4>
<p>Lycka core modules.</p>
<ul>
<?php foreach($modules as $module): ?>
  <?php if($module['isLyckaCore']): ?>
  <li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
  <?php endif; ?>
<?php endforeach; ?>
</ul>
...
<div class='box'>
<h4>Lycka CMF</h4>
<p>Lycka Content Management Framework (CMF) modules.</p>
<ul>
<?php foreach($modules as $module): ?>
  <?php if($module['isLyckaCMF']): ?>
  <li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
  <?php endif; ?>
<?php endforeach; ?>
</ul>
...
<div class='box'>
<h4>More modules</h4>
<p>Modules that does not implement any specific Lycka interface.</p>
<ul>
<?php foreach($modules as $module): ?>
  <?php if(!($module['isController'] || $module['isLyckaCore'] || $module['isLyckaCMF'])): ?>
  <li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
  <?php endif; ?>
<?php endforeach; ?>
</ul>
