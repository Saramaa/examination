<?php
/**
 * Main class for Lycka, holds everything.
 *
 * @package LyckaCore
 */
class CLycka implements ISingleton {
  ...
  /**
	 ...
	 * @return CLycka The instance of this class.
	 */
  ...
  public function ThemeEngineRender() {
    ...
    $themePath 	= LYCKA_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    if(isset($this->config['theme']['parent'])) {
      $parentPath = LYCKA_INSTALL_PATH . '/' . $this->config['theme']['parent'];
    ...
    $ly = &$this;
    // First the default Lycka themes/functions.php
