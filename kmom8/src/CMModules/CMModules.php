<?php
/**
 * A model for managing Lycka modules.
 * 
 * @package LyckaCore
 */
class CMModules extends CObject {
   ...
   * Properties
   */
  private $lyckaCoreModules = array('CLycka', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $lyckaCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isLyckaCore']   = in_array($rc->name, $this->lyckaCoreModules);
      $details['isLyckaCMF']    = in_array($rc->name, $this->lyckaCMFModules);
