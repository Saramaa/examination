<?php
/**
 * Holding a instance of CLycka to enable use of $this in subclasses and provide some helpers.
 *
 * @package LyckaCore
 */
class CObject {
	...
	/**
	 * Wrapper for same method in CLycka. See there for documentation.
	 */
